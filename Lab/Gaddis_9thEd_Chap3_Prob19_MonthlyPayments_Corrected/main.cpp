...
const unsigned char CNVPNYS=100;//Conversion from $'s to Pennies
const float HLFAPNY=0.005f;//Half a Penny
...
int main(int argc, char** argv) {
    ...
    //Mapping Process Inputs to Outputs, Knowns to Unknowns
    ...
    int imnPymt=(mnPymnt+HLFAPNY)*CNVPNYS;//Discrete number of pennies
    mnPymnt=static_cast<float>(imnPymt)/CNVPNYS;
